...
def create_spark_session(app_name: str = "TelcoChurnPipeline",
                         master: str = "local[*]",
                         config_options: Optional[dict] = None) -> SparkSession:
    try:
...
def get_spark_session_info(spark: SparkSession):
    try:
        info = {
...
def configure_spark_for_ml(spark: SparkSession):
    try:
...
def get_or_create_spark_session(app_name: str = "TelcoChurnPipeline", **kwargs) -> SparkSession:
